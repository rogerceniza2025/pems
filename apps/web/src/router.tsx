...
import App from './App'
import TailwindDemo from './routes/tailwind-demo'
import UIComponentsDemo from './routes/ui-components-demo'
import CustomComponentsDemo from './routes/custom-components-demo'
    ...
    <div class="container mx-auto px-4 py-8">
      <div class="space-y-8">
        ...
        <section class="hero-gradient rounded-lg p-8 text-center">
          <h2 class="text-4xl font-bold mb-4 text-gradient">Welcome to PEMS</h2>
        ...
        <section class="space-y-6">
          ...
          <div class="grid gap-4 md:grid-cols-2">
            ...
            <div class="card p-6">
              ...
              <p class="text-muted-foreground">
                Build responsive components based on their container size rather
                than viewport for more modular designs.
              </p>
            </div>
            <div class="card p-6">
              <h3 class="text-xl font-semibold mb-3 text-primary">
...
// Create tailwind demo route
const tailwindDemoRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/tailwind-demo',
  component: () => <TailwindDemo />,
})

// Create UI components demo route
const uiComponentsDemoRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/ui-components-demo',
  component: () => <UIComponentsDemo />,
})

// Create custom components demo route
const customComponentsDemoRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/custom-components-demo',
