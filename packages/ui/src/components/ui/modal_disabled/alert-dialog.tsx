    ...
    >
      <ModalHeader>
        <div class="flex items-center gap-3">
          <div class={`flex-shrink-0 w-10 h-10 rounded-full bg-${local.variant === 'destructive' ? 'red' : 'blue'}-100 flex items-center justify-center`}>
            <svg
            ...
            >
              <Show
                when={local.variant === 'destructive'}
                fallback={
                  <path
      ...
      <ModalFooter position="right">
        ...
        <Button
          variant={local.variant === 'destructive' ? 'destructive' : 'default'}
